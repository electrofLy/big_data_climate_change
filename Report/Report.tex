...
%Some successful matches:
%\begin{itemize}
%	\item Volkskrant `Opklaringen in de broeikas’ (`Clear skies in the greenhouse’) (21 September 2013, http://www.volkskrant.nl/archief/opklaringen-in-de-broeikas~a3513501/)
%	
%	\item Volkskrant `De dreigende kernramp in Japan vandaag van minuut tot minuut` (`The approaching threatening nuclear disaster in Japan today from minute to minute’) (16 March 2011, http://www.volkskrant.nl/buitenland/de-dreigende-kernramp-in-japan-vandaag-van-minuut-tot-minuut~a1860793/)
%	
%	\item Twitter `@Maarijex  ena natuurlijk mooi weer zon zon zon zon zon zon ;k;k;k`
%\end{itemize}
%
% Some failed matches:
% \begin{itemize}
% 	\item Volkskrant `De volledige tekst van de Troonrede’ (`the complete Troonrede text’) (18 September 2012, http://www.volkskrant.nl/politiek/de-volledige-tekst-van-de-troonrede~a3318354)
% 	
% 	\item Volkskrant `Dankuwel, crisis’ (`Thank you Crisis’) (11 June 2013, http://www.volkskrant.nl/archief/dankuwel-crisis~a3456355/)
% 	
% 	\item Twitter `Denken denken denken en denken denken denken denken denken en oja ook nog denken denken. Maar toch ook wel klein beetje denken hoor.’
% 	
% \end{itemize}
